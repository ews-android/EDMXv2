package com.festivalguide.v2.edmx.com.festivalguide.v2.edmx.com.festivalguide.v2.edmx.fragments;
...
import com.festivalguide.v2.edmx.com.festivalguide.v2.edmx.adapter.ViewPagerAdapter;
 ...
 */
public class HomeFragment extends EDMXBaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        country = new String[] { "EDMX Events", "Festivals", "Artists",
                "Artist Tags" };

        population = new String[] { "1,354,040,000", "1,210,193,422",
                "315,761,000", "237,641,326" };

        flag = new int[] { R.drawable.applemusic, R.drawable.balloons,
                R.drawable.glimmer, R.drawable.pakistan,
                 };
    }
